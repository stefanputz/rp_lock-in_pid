...
int lock_update_main(rp_app_params_t *params)
{
    ...
    params[186].value = (float)g_lock_reg->pidA_ofs              ; // lock_pidA_ofs
    params[187].value = (float)g_lock_reg->pidA_kp               ; // lock_pidA_kp
    params[188].value = (float)g_lock_reg->pidA_ki               ; // lock_pidA_ki
    params[189].value = (float)g_lock_reg->pidA_kd               ; // lock_pidA_kd
    params[190].value = (float)g_lock_reg->pidA_in               ; // lock_pidA_in
    params[191].value = (float)g_lock_reg->pidA_out              ; // lock_pidA_out
    params[192].value = (float) ((g_lock_reg->pidA_ctrl                 )& 0x001) ; // lock_pidA_irst
    params[193].value = (float) ((g_lock_reg->pidA_ctrl            >>1  )& 0x001) ; // lock_pidA_freeze
    params[194].value = (float) ((g_lock_reg->pidA_ctrl            >>2  )& 0x001) ; // lock_pidA_ifreeze
    params[195].value = (float)g_lock_reg->ctrl_A                ; // lock_ctrl_A
    params[196].value = (float)g_lock_reg->pidB_sw               ; // lock_pidB_sw
    params[197].value = (float)g_lock_reg->pidB_PSR              ; // lock_pidB_PSR
    params[198].value = (float)g_lock_reg->pidB_ISR              ; // lock_pidB_ISR
    params[199].value = (float)g_lock_reg->pidB_DSR              ; // lock_pidB_DSR
    params[200].value = (float)g_lock_reg->pidB_SAT              ; // lock_pidB_SAT
    params[201].value = (float)g_lock_reg->pidB_sp               ; // lock_pidB_sp
    params[202].value = (float)g_lock_reg->pidB_ofs              ; // lock_pidB_ofs
    params[203].value = (float)g_lock_reg->pidB_kp               ; // lock_pidB_kp
    params[204].value = (float)g_lock_reg->pidB_ki               ; // lock_pidB_ki
    params[205].value = (float)g_lock_reg->pidB_kd               ; // lock_pidB_kd
    params[206].value = (float)g_lock_reg->pidB_in               ; // lock_pidB_in
    params[207].value = (float)g_lock_reg->pidB_out              ; // lock_pidB_out
    params[208].value = (float) ((g_lock_reg->pidB_ctrl                 )& 0x001) ; // lock_pidB_irst
    params[209].value = (float) ((g_lock_reg->pidB_ctrl            >>1  )& 0x001) ; // lock_pidB_freeze
    params[210].value = (float) ((g_lock_reg->pidB_ctrl            >>2  )& 0x001) ; // lock_pidB_ifreeze
    params[211].value = (float)g_lock_reg->ctrl_B                ; // lock_ctrl_B
    params[212].value = (float)g_lock_reg->pidC_sw               ; // lock_pidC_sw
    params[213].value = (float)g_lock_reg->pidC_PSR              ; // lock_pidC_PSR
    params[214].value = (float)g_lock_reg->pidC_ISR              ; // lock_pidC_ISR
    params[215].value = (float)g_lock_reg->pidC_DSR              ; // lock_pidC_DSR
    params[216].value = (float)g_lock_reg->pidC_SAT              ; // lock_pidC_SAT
    params[217].value = (float)g_lock_reg->pidC_sp               ; // lock_pidC_sp
    params[218].value = (float)g_lock_reg->pidC_ofs              ; // lock_pidC_ofs
    params[219].value = (float)g_lock_reg->pidC_kp               ; // lock_pidC_kp
    params[220].value = (float)g_lock_reg->pidC_ki               ; // lock_pidC_ki
    params[221].value = (float)g_lock_reg->pidC_kd               ; // lock_pidC_kd
    params[222].value = (float)g_lock_reg->pidC_in               ; // lock_pidC_in
    params[223].value = (float)g_lock_reg->pidC_out              ; // lock_pidC_out
    params[224].value = (float) ((g_lock_reg->pidC_ctrl                 )& 0x001) ; // lock_pidC_irst
    params[225].value = (float) ((g_lock_reg->pidC_ctrl            >>1  )& 0x001) ; // lock_pidC_freeze
    params[226].value = (float) ((g_lock_reg->pidC_ctrl            >>2  )& 0x001) ; // lock_pidC_ifreeze
    params[227].value = (float)g_lock_reg->ctrl_C                ; // lock_ctrl_C
    params[228].value = (float)g_lock_reg->aux_A                 ; // lock_aux_A
    params[229].value = (float)g_lock_reg->aux_B                 ; // lock_aux_B
    params[230].value = (float) (( g_lock_reg->lock_feedback >> 0 ) & 0x01 ) ; // lock_ctrl_aux_lock_now
    params[231].value = (float) (( g_lock_reg->lock_feedback >> 1 ) & 0x01 ) ; // lock_ctrl_aux_launch_lock_trig
    params[232].value = (float) (( g_lock_reg->lock_feedback >> 2 ) & 0x01 ) ; // lock_ctrl_aux_pidC_enable_ctrl
    params[233].value = (float) (( g_lock_reg->lock_feedback >> 3 ) & 0x01 ) ; // lock_ctrl_aux_pidB_enable_ctrl
    params[234].value = (float) (( g_lock_reg->lock_feedback >> 4 ) & 0x01 ) ; // lock_ctrl_aux_pidA_enable_ctrl
    params[235].value = (float) (( g_lock_reg->lock_feedback >> 5 ) & 0x01 ) ; // lock_ctrl_aux_ramp_enable_ctrl
    params[236].value = (float) (( g_lock_reg->lock_feedback >> 6 ) & 0x01 ) ; // lock_ctrl_aux_set_pidC_enable
    params[237].value = (float) (( g_lock_reg->lock_feedback >> 7 ) & 0x01 ) ; // lock_ctrl_aux_set_pidB_enable
    params[238].value = (float) (( g_lock_reg->lock_feedback >> 8 ) & 0x01 ) ; // lock_ctrl_aux_set_pidA_enable
    params[239].value = (float) (( g_lock_reg->lock_feedback >> 9 ) & 0x01 ) ; // lock_ctrl_aux_set_ramp_enable
    params[240].value = (float) (( g_lock_reg->lock_feedback >>10 ) & 0x03 ) ; // lock_ctrl_aux_trig_type
    params[241].value = (float) (( g_lock_reg->lock_feedback >>12 ) & 0x01 ) ; // lock_ctrl_aux_lock_trig_rise
